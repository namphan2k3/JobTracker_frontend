...
export function ResendVerificationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (Array.isArray(errors) && errors.length > 0) {
        ...
        setError(msg || 'Gửi email xác thực thất bại');
      }
    } finally {
      setLoading(false);
    }
    ...
    return (
      <div className={styles.authForm}>
        ...
        <p className={styles.authForm__message}>
          Nếu email tồn tại và chưa xác thực, bạn sẽ nhận được link xác thực
          mới. Kiểm tra hộp thư (và thư mục spam).
        </p>
  ...
  return (
    <div className={styles.authForm}>
      <h1 className={styles.authForm__title}>Gửi lại email xác thực</h1>
